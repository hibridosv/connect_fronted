...
export function ContactDetailsGT(props: ContactDetailsGTProps) {
  ...
  const taxpayerTypeLabel = record?.taxpayer_type == 2 ? 'Pequeño contribuyente' : 'Contribuyente';
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="bg-bg-content rounded-lg shadow-sm border border-bg-subtle p-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
          ...
          {record?.id_number && (
            <div>
              <div className="text-text-muted text-xs uppercase font-medium">NIT</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2">
          ...
          {record?.taxpayer_type && (
            <div className="md:col-span-2">
              ...
              <div className="text-text-base text-sm font-semibold">{taxpayerTypeLabel}</div>
            </div>
          )}
        </div>
      </div>
