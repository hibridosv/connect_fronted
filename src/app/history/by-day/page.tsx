...
import { HistoryByDayTable } from "@/components/history/HistoryByDayTable";
...
export default function Page() {
  ...
  return (
    ...
    <div className="md:col-span-7 md:border-r md:border-primary">
        <ViewTitle text="Listado de ordenes por día" />
        <div className="p-4">
          <HistoryByDayTable records={history} isLoading={isLoading} />
        </div>
    </div>
